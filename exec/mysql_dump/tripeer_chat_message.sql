...
CREATE TABLE `chat_message` (
  ...
  KEY `FK_plan_TO_chat_message_1` (`plan_id`),
  KEY `FK_user_TO_chat_message_1` (`user_id`),
  CONSTRAINT `FK_plan_TO_chat_message_1` FOREIGN KEY (`plan_id`) REFERENCES `plan` (`plan_id`),
  CONSTRAINT `FK_user_TO_chat_message_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`)
