...
CREATE TABLE `receipt` (
  ...
  KEY `FK_plan_day_TO_receipt_1` (`plan_day_id`),
  CONSTRAINT `FK_plan_day_TO_receipt_1` FOREIGN KEY (`plan_day_id`) REFERENCES `plan_day` (`plan_day_id`)
...
-- Dump completed on 2024-05-17 13:12:00
